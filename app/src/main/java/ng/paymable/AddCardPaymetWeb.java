...
public class AddCardPaymetWeb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = AddCardPaymetWeb.this;
        ...
        Intent intent = getIntent();
            ...
            PAYMENT_YES = Config.url + "authentication.cardinalcommerce.com";
            url = Config.url + "credit/add_new_card.php?userid="+sessionHandlerUser.getUserDetail().getUserid();
...
//            viewDialog.hideDialog();
            ...
            if (url.equals(PAYMENT_SUCCESS)) {
                ...
                wvPayment.clearHistory();
                wvPayment.destroy();
            }else if (url.contains(PAYMENT_YES)) {
                wvPayment.goBack();
                super.onPageFinished(view, PAYMENT_YES);
            } else {
...
//            viewDialog.hideDialog();
        ...
        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(AddCardPaymetWeb.this).create();
