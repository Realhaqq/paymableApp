...
public class MainActivity extends AppCompatActivity {
    ...
    String backend_url = "https://paymable.ng/api/v1/pay/charge.php";
    // Set this to a public key that matches the secret key you supplied while creating the heroku instance
    String paystack_public_key = "pk_live_28488d18b24729956940044bd50ddd9f759954ec";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.paystack_main);
    ...
    private class verifyOnServer extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... reference) {
            try {
                ...
                URL url = new URL("https://paymable.ng/api/v1/pay/verify.php?ref=" + this.reference);
                BufferedReader in = new BufferedReader(
                        new InputStreamReader(
                                url.openStream()));
